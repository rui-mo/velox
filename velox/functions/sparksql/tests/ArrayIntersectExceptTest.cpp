...
class ArrayIntersectExceptTest : public SparkFunctionBaseTest {
 protected:
  ...
  void testArrayExceptFloatingPoint() {
    ...
    testExpr(expected, "array_except(C0, C1)", getInputArrayVectors<T>());
    ...
    testExpr(expected, "array_except(C1, C0)", getInputArrayVectors<T>());
  }
  ...
  void testArrayIntersectFloatingPoint() {
    ...
    testExpr(expected, "array_intersect(C0, C1)", getInputArrayVectors<T>());
    ...
    testExpr(expected, "array_intersect(C1, C0)", getInputArrayVectors<T>());
  }

 private:
  template <typename T>
  std::vector<VectorPtr> getInputArrayVectors() {
