...
class FunctionBaseTest : public testing::Test,
 ...
 protected:
  ...
  // Returns a vector of signatures for the given function name and return type.
  // @param returnType The name of expected return type defined in function signature. 
